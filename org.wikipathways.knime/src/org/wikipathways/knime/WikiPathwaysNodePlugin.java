 ...
 */
public class WikiPathwaysNodePlugin extends Plugin {
    // The shared instance.
    private static WikiPathwaysNodePlugin plugin;

    /**
     * The constructor.
     */
    public WikiPathwaysNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WikiPathwaysNodePlugin getDefault() {
        return plugin;
    }
